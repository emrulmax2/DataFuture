    ...
    if ($("#termTypeTableId").length) {
            ...
            axios({
                ...
                if (response.status == 200) {
                    ...
                    if(dataset.is_active == 1){
                        document.querySelector('#editModal #is_active').checked = true;
                        $('#editModal .is_active').fadeIn(500, function () {
                            $('#editModal input[name="is_active"]').val(dataset.is_active ? dataset.is_active : '');
                        });
                    }else{
                        document.querySelector('#editModal #is_active').checked = false;
                        $('#editModal .is_active').fadeOut(500, function () {
                            $('#editModal input[name="is_active"]').val('');
                        });
                    }
        ...
        $('#termTypeTableId').on('click', '.delete_btn', function(){
            ...
            document.getElementById('confirmModal').addEventListener('shown.tw.modal', function(event){
                ...
                $('#confirmModal .confModDesc').html('Want to delete this term type from applicant list? Please click on agree to continue.');
