        ...
        let tableContent = new Tabulator("#applicantUploadListTable", {
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter(cell, formatterParams) {                        
                        var btns = "";
                        btns +='<a data-id="' + cell.getData().id + '" href="javascript:void(0);" download class="downloadDoc btn-rounded btn btn-linkedin text-white p-0 w-9 h-9 ml-1"><i data-lucide="cloud-lightning" class="w-4 h-4"></i></a>';
