...
<div id="addCourseCreationDataFutureModal" class="modal" tabindex="-1" aria-hidden="true">
...
<!-- BEGIN: Add Base Data Future Modal -->
<div id="editCourseCreationDataFutureModal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
