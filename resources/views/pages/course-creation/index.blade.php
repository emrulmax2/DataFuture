...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Course Creations List</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button data-tw-toggle="modal" data-tw-target="#addCourseCreationModal" type="button" class="add_btn btn btn-primary shadow-md mr-2">Add Course Creation</button>
        </div>
    </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form id="tabulatorFilterForm-01" class="xl:flex sm:mr-auto" >
                ...
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    ...
                    <select id="course-01" name="course" class="form-select w-full mt-2 sm:mt-0 sm:w-auto" >
                ...
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    ...
                    <select id="semester-01" name="semester" class="form-select w-full mt-2 sm:mt-0 sm:w-auto" >
                        <option value="">Please Select</option>
                        @if(!empty($semesters))
    ...
    <!-- END: HTML Table Data -->
    <!-- BEGIN: Add Modal -->
    <div id="addCourseCreationModal" class="modal" tabindex="-1" aria-hidden="true">
    ...
    <!-- END: Add Modal -->
    <!-- BEGIN: Edit Modal -->
    <div id="editCourseCreationModal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
