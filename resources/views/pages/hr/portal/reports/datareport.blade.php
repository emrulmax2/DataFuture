            ...
            <div class="grid grid-cols-12 gap-4 mt-10 employeementsRows">
                ...
                <div class="col-span-3">
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s22">Started On</label>
                    </div>
            ...
            <div class="grid grid-cols-12 gap-4 mt-10 elegibilityRow">
                ...
                <div class="col-span-3">
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s57">Permit Type</label>
                    </div>
                ...
                <div class="col-span-3">
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s62">Issuing Country</label>
                    </div>
            ...
            <div class="grid grid-cols-12 gap-4 mt-10 emmContactRow">
                ...
                <div class="col-span-3">
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s64">Kin Relation</label>
                ...
                <div class="col-span-3">
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s64">Telephone</label>
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s64">Mobile</label>
                ...
                <div class="col-span-3">
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s64">Email</label>
                    ...
                    <div class="singlefields relative mb-2">
                        ...
                        <label class= "cursor-pointer ml-2" for="s64">Address</label>
