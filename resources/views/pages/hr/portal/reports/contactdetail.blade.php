        ...
        <form id="tabulatorFilterForm-ECD">
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-3">
                    ...
                    <select id="employee_work_type_id-contact" class="lccToms tom-selects w-full" name="employee_work_type_id"> 
                ...
                <div class="col-span-2">
                    ...
                    <select id="department_id-contact" name="department_id" class="w-full lccToms tom-selects">     
                        <option value="" selected>Please Select</option>             
                ...
                <div class="col-span-3">
                    ...
                    <select id="ethnicity-contact" name="ethnicity" class="lccToms tom-selects w-full">
                        <option value="" selected>Please Select</option>
                        @if(!empty($ethnicity))
                ...
                <div class="col-span-3">
                    ...
                    <select id="nationality-contact" name="nationality" class="lccToms tom-selects w-full">
                        <option value="" selected>Please Select</option>
                        @if(!empty($country))
                ...
                <div class="col-span-2">
                    ...
                    <select id="gender-contact" name="gender" class="lccToms tom-selects w-full">
                        <option value="" selected>Please Select</option>
                        @if(!empty($gender))
                            @foreach($gender as $n)
                ...
                <div class="col-span-2">
                    ...
                    <select id="status_id-contact" name="status_id" class="w-full lccToms tom-selects">     
