                                ...
                                <div class="grid grid-cols-12 gap-x-4">
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        <div class="validationGroup">
                                            <input value="{{ isset($apply->referral_code) ? $apply->referral_code : ( isset(auth('agent')->user()) ? $agentCode : '' ) }}" data-org="{{ isset($apply->referral_code) ? $apply->referral_code : ( isset(auth('agent')->user()) ? $agentCode : '' ) }}" id="referral_code" name="referral_code" type="text" class="form-control w-full"  placeholder="Referral Code">
