...
@section('content')
    <div id="siteSettingsPage" class="ss-page ss-residency-status-page">
        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Maintain the residency status options used in applications and student records.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <aside class="ss-sidebar">
                    @php
                        $settingsSidebarIcon = 'home';
                        $settingsSidebarSubtitle = 'Student profile setup';
                    @endphp
                    @include('pages.settings.sidebar')
                </aside>

                <section class="ss-content">
                    <div class="ss-table-card ss-residency-status-card">
                        <div class="ss-table-card__header">
                            <div>
                                <h2>Residency Status List</h2>
                                <p>Application and student profile residency choices</p>
                            </div>
                            ...
                            <form id="tabulatorFilterForm" class="ss-table-filter">
                                <div class="ss-filter-field">
                                    ...
                                    <label class="ss-filter-input" for="query">
                                        ...
                                        <input id="query" name="query" type="text" placeholder="Search residency status...">
                                    </label>
                                </div>
                                <div class="ss-filter-field">
                                    <span>Status</span>
                        ...
                        <div class="ss-tabulator-wrap">
                            <div id="residencyStatusTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div id="addModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog ss-residency-status-modal-dialog">
                <form method="POST" action="#" id="addForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-compact-settings-modal ss-residency-status-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                                <h2>Add Residency Status</h2>
                            </div>
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="add_residency_name">Residency Status <span>*</span></label>
                                <input id="add_residency_name" type="text" name="name" class="ss-modal-input name" placeholder="Residency status">
            ...
            <div class="modal-dialog ss-settings-modal__dialog ss-residency-status-modal-dialog">
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-compact-settings-modal ss-residency-status-modal">
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="edit_residency_name">Residency Status <span>*</span></label>
                                <input id="edit_residency_name" type="text" name="name" class="ss-modal-input name" placeholder="Residency status">
                                <div class="acc__input-error error-name"></div>
                            </div>
                        </div>
                        <div class="modal-footer ss-settings-modal__footer">
...
@section('script')
    ...
    @vite('resources/js/residency_status.js')
