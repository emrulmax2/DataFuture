...
@section('content')
    <div id="siteSettingsPage" class="ss-page ss-issue-type-page">
        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Manage Report IT categories, audience availability and notification routing.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <aside class="ss-sidebar">
                    @php
                        $settingsSidebarIcon = 'computer';
                        $settingsSidebarSubtitle = 'Report IT setup';
                    @endphp
                    @include('pages.settings.sidebar')
                </aside>

                <section class="ss-content">
                    <div class="ss-table-card ss-issue-type-card">
                        <div class="ss-table-card__header">
                            <div>
                                <h2>Issue Types List</h2>
                                <p>Report IT categories and reporting inboxes</p>
                            </div>
                            ...
                            <form id="tabulatorFilterForm" class="ss-table-filter">
                                <div class="ss-filter-field">
                                    ...
                                    <label class="ss-filter-input" for="query">
                                        ...
                                        <input id="query" name="query" type="text" placeholder="Search issue types...">
                                    </label>
                                </div>
                                <div class="ss-filter-field">
                                    <span>Status</span>
                        ...
                        <div class="ss-tabulator-wrap">
                            <div id="issueTypesTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div id="addModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog ss-issue-type-modal-dialog">
                <form method="POST" action="#" id="addForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-issue-type-modal">
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-grid ss-issue-type-fields">
                                <div class="ss-modal-field">
                                    <label for="add_issue_name">Issue Type <span>*</span></label>
                                    <input id="add_issue_name" type="text" name="name" class="ss-modal-input name" placeholder="Issue type">
                                    <div class="acc__input-error error-name"></div>
                                </div>
                                <div class="ss-modal-field">
                                    <label for="add_reporting_email">Reporting Email <span>*</span></label>
                                    <input id="add_reporting_email" type="email" name="reporting_email" class="ss-modal-input reporting_email" placeholder="reporting@example.com">
                                    <div class="acc__input-error error-reporting_email"></div>
                                </div>
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label>Available To <span>*</span></label>
                                    <div class="ss-issue-availability-grid availability" data-availability-group>
                                        <label class="ss-status-toggle ss-issue-availability-option" for="add_availability_employee">
                                            <input id="add_availability_employee" type="radio" name="availability" value="Employee" autocomplete="off">
                                            ...
                                            <span class="ss-status-toggle__copy">
                                                ...
                                                <small>Staff reports</small>
                                            </span>
                                        </label>
                                        <label class="ss-status-toggle ss-issue-availability-option" for="add_availability_student">
                                            <input id="add_availability_student" type="radio" name="availability" value="Student" autocomplete="off">
                                            <span class="ss-status-toggle__control">
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--on"><i data-lucide="check"></i></span>
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--off"><i data-lucide="x"></i></span>
                                            </span>
                                        ...
                                        <label class="ss-status-toggle ss-issue-availability-option" for="add_availability_both">
                                            <input id="add_availability_both" type="radio" name="availability" value="Both" autocomplete="off">
                                            <span class="ss-status-toggle__control">
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--on"><i data-lucide="check"></i></span>
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--off"><i data-lucide="x"></i></span>
                                            </span>
                                            <span class="ss-status-toggle__copy">
                                                <strong>Both</strong>
                                                <small>All reporters</small>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="acc__input-error error-availability"></div>
                                </div>
                            </div>
                        </div>
                ...
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-issue-type-modal">
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-grid ss-issue-type-fields">
                                <div class="ss-modal-field">
                                    <label for="edit_issue_name">Issue Type <span>*</span></label>
                                    <input id="edit_issue_name" type="text" name="name" class="ss-modal-input name" placeholder="Issue type">
                                    <div class="acc__input-error error-name"></div>
                                </div>
                                <div class="ss-modal-field">
                                    <label for="edit_reporting_email">Reporting Email <span>*</span></label>
                                    <input id="edit_reporting_email" type="email" name="reporting_email" class="ss-modal-input reporting_email" placeholder="reporting@example.com">
                                    <div class="acc__input-error error-reporting_email"></div>
                                </div>
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label>Available To <span>*</span></label>
                                    <div class="ss-issue-availability-grid availability" data-availability-group>
                                        <label class="ss-status-toggle ss-issue-availability-option" for="edit_availability_employee">
                                            <input id="edit_availability_employee" type="radio" name="availability" value="Employee" autocomplete="off">
                                            <span class="ss-status-toggle__control">
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--on"><i data-lucide="check"></i></span>
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--off"><i data-lucide="x"></i></span>
                                            </span>
                                        ...
                                        <label class="ss-status-toggle ss-issue-availability-option" for="edit_availability_student">
                                            <input id="edit_availability_student" type="radio" name="availability" value="Student" autocomplete="off">
                                            <span class="ss-status-toggle__control">
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--on"><i data-lucide="check"></i></span>
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--off"><i data-lucide="x"></i></span>
                                            </span>
                                        ...
                                        <label class="ss-status-toggle ss-issue-availability-option" for="edit_availability_both">
                                            <input id="edit_availability_both" type="radio" name="availability" value="Both" autocomplete="off">
                                            <span class="ss-status-toggle__control">
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--on"><i data-lucide="check"></i></span>
                                                <span class="ss-status-toggle__icon ss-status-toggle__icon--off"><i data-lucide="x"></i></span>
                                            </span>
