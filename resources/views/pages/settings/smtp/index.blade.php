...
@section('subcontent')
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Common SMTP</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addSmtpModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto">Add New SMTP</button>
                </div>
                <div class="p-5">
    ...
    <!-- BEGIN: Edit Modal -->
    <div id="editSmtpModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="form-check form-switch mb-0 mt-1" style="float: left;">
                            <label class="form-check-label ml-0 mr-3" for="edit_is_default">Is Default?</label>
                            <input id="edit_is_default" name="is_default" value="1" class="form-check-input" type="checkbox">
                        </div>
    ...
    <!-- BEGIN: Add Modal -->
    <div id="addSmtpModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="addSmtpForm" enctype="multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="form-check form-switch mb-0 mt-1" style="float: left;">
                            <label class="form-check-label ml-0 mr-3" for="is_default">Is Default?</label>
                            <input id="is_default" name="is_default" value="1" class="form-check-input" type="checkbox">
                        </div>
                        <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-20 mr-1">Cancel</button>
