            ...
            <div class="ss-workspace">
                ...
                <section class="ss-content">
                    @if(isset(auth()->user()->priv()['course_parameters']) && auth()->user()->priv()['course_parameters'] == 1)
                        <div class="ss-table-card ss-termtype-card">
                            <div class="ss-table-card__header">
                                <h2>Term Type List</h2>
                            ...
                            <div class="ss-tabulator-wrap">
                                <div id="termTypeTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                            </div>
                        </div>
                    @else
        ...
        <div id="addModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog">
                <form method="POST" action="#" id="addForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-term-type-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                                <h2>Add New Term Type</h2>
                            </div>
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="add_name">Term Type <span>*</span></label>
                                <input id="add_name" type="text" name="name" class="ss-modal-input name" placeholder="Autumn Term">
                                <div class="acc__input-error error-name"></div>
                            </div>

                            <div class="ss-modal-field">
                                <label for="add_code">Code <span>*</span></label>
                                <input id="add_code" type="text" name="code" class="ss-modal-input code" placeholder="AUT">
                            ...
                            <div class="ss-modal-field">
                                ...
                                <label class="ss-status-toggle" for="add_is_active">
                                    ...
                                    <span class="ss-status-toggle__copy">
                                        ...
                                        <small>Not available for new term setup</small>
                                    </span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="modal-dialog ss-settings-modal__dialog">
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-term-type-modal">
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="edit_name">Term Type <span>*</span></label>
                                <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="Autumn Term">
                                <div class="acc__input-error error-name"></div>
                            </div>

                            <div class="ss-modal-field">
                                <label for="edit_code">Code <span>*</span></label>
                                <input id="edit_code" type="text" name="code" class="ss-modal-input code" placeholder="AUT">
                                <div class="acc__input-error error-code"></div>
                            </div>
