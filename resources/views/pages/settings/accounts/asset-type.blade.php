...
@section('content')
    <div id="siteSettingsPage" class="ss-page">
        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Group the assets recorded in the register by the type of item they are.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <section class="ss-content">
                    <div class="ss-table-card ss-asset-type-card">
                        <div class="ss-table-card__header">
                            <h2>Asset Types</h2>
                            <button data-tw-toggle="modal" data-tw-target="#addAssetTypeModal" type="button" class="add_btn ss-btn ss-btn--primary ss-btn--compact">
                        ...
                        <div class="ss-tabulator-wrap">
                            <div id="assetTypeListTable" class="ss-tabulator table-report table-report--tabulator"></div>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div id="addAssetTypeModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog">
                <form method="POST" action="#" id="addAssetTypeForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-asset-type-modal">
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                ...
                                <input id="name" type="text" name="name" class="ss-modal-input name" placeholder="Asset type name">
                                <div class="acc__input-error error-name"></div>
                            </div>

                            <div class="ss-modal-field">
                                <label for="active">Active Status</label>
                                <label class="ss-status-toggle" for="active">
                                    <input checked id="active" name="active" value="1" type="checkbox" autocomplete="off">
                                    ...
                                    <span class="ss-status-toggle__copy">
                                        ...
                                        <small>Selectable when registering assets</small>
                                    </span>
                                </label>
                            </div>
                        </div>
                        <div class="ss-settings-modal__footer">
                            ...
                            <button type="submit" id="saveAssetType" class="ss-btn ss-btn--primary">
        ...
        <div id="editAssetTypeModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog">
                <form method="POST" action="#" id="editAssetTypeForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-asset-type-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                ...
                                <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="Asset type name">
                                <div class="acc__input-error error-name"></div>
                            </div>
                            ...
                            <div class="ss-modal-field">
                                ...
                                <label class="ss-status-toggle" for="edit_active">
                                    ...
                                    <span class="ss-status-toggle__copy">
                                        ...
                                        <small>Not selectable when registering assets</small>
                                    </span>
                                </label>
                            </div>
                        </div>
                        <div class="ss-settings-modal__footer">
                            ...
                            <button type="submit" id="updateAssetType" class="ss-btn ss-btn--primary">
                                <svg style="display: none;" width="25" viewBox="-2 -2 42 42" xmlns="http://www.w3.org/2000/svg" stroke="white" class="ss-spinner">
                                    <g fill="none" fill-rule="evenodd">
                                        <g transform="translate(1 1)" stroke-width="4">
                                            <circle stroke-opacity=".5" cx="18" cy="18" r="18"></circle>
...
@section('script')
    ...
    @vite('resources/js/acc-asset-type.js')
