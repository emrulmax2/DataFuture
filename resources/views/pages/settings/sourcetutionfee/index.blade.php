...
@section('content')
    ...
    <div id="siteSettingsPage" class="ss-page">
        ...
        <nav class="ss-breadcrumb" aria-label="Breadcrumb">
            ...
            <i data-lucide="chevron-right"></i>
            <span>Source of Tuition Fees</span>
        </nav>
        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Manage tuition fee sources, academic years, term types, assessments and awarding bodies.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <section class="ss-content">
                    @if(isset(auth()->user()->priv()['course_parameters']) && auth()->user()->priv()['course_parameters'] == 1)
                        <div class="ss-table-card ss-tuitionsource-card">
                            <div class="ss-table-card__header">
                                <h2>Source of Tuition Fees List</h2>
                            ...
                            <div class="ss-tabulator-wrap">
                                <div id="tuitionsourceTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                            </div>
                        </div>
                    @else
                ...
                <form method="POST" action="#" id="addForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                                <h2>Add Source of Tuition Fee</h2>
                            </div>
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="add_name">Source of Tuition Fee <span>*</span></label>
                                <input id="add_name" type="text" name="name" class="ss-modal-input name" placeholder="Source of tuition fee">
                ...
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                                <h2>Edit Source of Tuition Fee</h2>
                            </div>
                            <button type="button" data-tw-dismiss="modal" class="ss-modal-close" aria-label="Close modal">
                                <i data-lucide="x"></i>
                            </button>
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="edit_name">Source of Tuition Fee <span>*</span></label>
                                <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="Source of tuition fee">
                                <div class="acc__input-error error-name"></div>
                            </div>
...
@section('script')
    ...
    @vite('resources/js/sourcetuitionfee.js')
