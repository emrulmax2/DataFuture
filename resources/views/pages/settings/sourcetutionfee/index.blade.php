...
@section('subhead')
    <title>Source of Tuition Fees</title>
@endsection
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Source of Tuition Fees List</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addModal" type="button" class="add_btn btn btn-primary shadow-md ml-0">Add New Tuition Fee</button>
                </div>
                <div class="p-5">
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="tuitionsourceTableId" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="#" id="addForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Add Source of Tuition Fee</h2>
                    ...
                    <div class="modal-body">
                        <div>
                            <label for="name" class="form-label">Source of Tuition Fee <span class="text-danger">*</span></label>
            ...
            <form method="POST" action="#" id="editForm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="update"a class="btn btn-primary w-auto">
                            Update
                            <svg style="display: none;" width="25" viewBox="-2 -2 42 42" xmlns="http://www.w3.org/2000/svg"
                                stroke="white" class="w-4 h-4 ml-2">
                                <g fill="none" fill-rule="evenodd">
