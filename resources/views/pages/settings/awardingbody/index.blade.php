        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Manage awarding bodies, term types, assessments, academic years and qualifications.</p>
                    </div>
                </div>
                    ...
                    @if(isset(auth()->user()->priv()['course_parameters']) && auth()->user()->priv()['course_parameters'] == 1)
                        <div class="ss-table-card ss-awarding-card">
                            ...
                            <div class="ss-tabulator-wrap">
                                <div id="awardingbodyTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                            </div>
                        </div>
                    @else
                    ...
                    <div class="modal-content ss-settings-modal">
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="add_name">Awarding Body <span>*</span></label>
                                <input id="add_name" type="text" name="name" class="ss-modal-input name" placeholder="Awarding body">
            ...
            <div class="modal-dialog ss-settings-modal__dialog">
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal">
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="edit_name">Awarding Body <span>*</span></label>
                                <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="Awarding body">
                                <div class="acc__input-error error-name"></div>
                            </div>
...
@section('script')
    ...
    @vite('resources/js/awardingbody.js')
