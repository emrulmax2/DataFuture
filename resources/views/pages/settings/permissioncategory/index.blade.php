        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Manage permission categories, grouped as sub departments under each department.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <aside class="ss-sidebar">
                    {{-- Same header as the other User Privilege screens, so the
                         sidebar does not change identity when moving between
                         Departments and Permission Category. --}}
                    @php
                        $settingsSidebarIcon = 'contact-2';
                        $settingsSidebarSubtitle = 'HR settings';
                    @endphp
                    ...
                    @if(isset(auth()->user()->priv()['user_privilege']) && auth()->user()->priv()['user_privilege'] == 1)
                        <div class="ss-table-card">
                            <div class="ss-table-card__header">
                                <h2>Permission Category List</h2>
                            ...
                            <div class="ss-table-tools">
                                <form id="tabulatorFilterForm" class="ss-table-filter">
                                    ...
                                    <div class="ss-filter-field">
                                        ...
                                        <label class="ss-filter-select" for="department">
                            ...
                            <div class="ss-tabulator-wrap">
                                <div id="permissioncategoryTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                            </div>
                        </div>
                    @else
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-grid">
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="add_department_id">Department <span>*</span></label>
                                    <label class="ss-modal-select" for="add_department_id">
                                        <select id="add_department_id" name="department_id" class="department_id">
                                ...
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="add_name">Sub Department Name <span>*</span></label>
                                    <input id="add_name" type="text" name="name" class="ss-modal-input name" placeholder="e.g. Operations">
                ...
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-compact-settings-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                                <h2>Edit Permission Category</h2>
                            </div>
                            <button type="button" data-tw-dismiss="modal" class="ss-modal-close" aria-label="Close modal">
                                <i data-lucide="x"></i>
                            </button>
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-grid">
                                <div class="ss-modal-field ss-modal-field--full">
                                    ...
                                    <label class="ss-modal-select" for="edit_department_id">
                                        <select id="edit_department_id" name="department_id" class="department_id">
                                            <option value="">Please Select</option>
                                            @foreach($departments as $department)
                                                <option value="{{ $department->id }}">{{ $department->name }}</option>
                                            @endforeach
                                ...
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="edit_name">Sub Department Name <span>*</span></label>
                                    <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="e.g. Operations">
                                    <div class="acc__input-error error-name"></div>
                                </div>
                            </div>
                        </div>
