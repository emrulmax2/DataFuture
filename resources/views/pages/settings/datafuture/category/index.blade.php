...
@section('content')
    <div id="siteSettingsPage" class="ss-page ss-df-category-page">
        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Maintain the category groups used to organize Datafuture field mapping.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <section class="ss-content">
                    <div class="ss-table-card ss-df-category-card">
                        <div class="ss-table-card__header">
                            <div>
                                <h2>DF Field Categories List</h2>
                                <p>Category records used by Datafuture fields</p>
                            </div>
                            ...
                            <form id="tabulatorFilterForm" class="ss-table-filter">
                                <div class="ss-filter-field">
                                    ...
                                    <label class="ss-filter-input" for="query">
                                        ...
                                        <input id="query" name="query" type="text" placeholder="Search categories...">
                                    </label>
                                </div>
                                <div class="ss-filter-field">
                                    <span>Status</span>
                        ...
                        <div class="ss-tabulator-wrap">
                            <div id="dfFieldCategoryTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div id="addSettingsModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog ss-df-category-modal-dialog">
                <form method="POST" action="#" id="addSettingsForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-compact-settings-modal ss-df-category-modal">
                        <div class="ss-settings-modal__header">
                            <div>
                                <span></span>
                                <h2>Add DF Field Category</h2>
                            </div>
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-field">
                                ...
                                <input id="name" type="text" name="name" class="ss-modal-input name" placeholder="Category name">
            ...
            <div class="modal-dialog ss-settings-modal__dialog ss-df-category-modal-dialog">
                <form method="POST" action="#" id="editSettingsForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-compact-settings-modal ss-df-category-modal">
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-field">
                                <label for="edit_name">Category Name <span>*</span></label>
                                <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="Category name">
                                <div class="acc__input-error error-name"></div>
                            </div>
                        </div>
                        <div class="modal-footer ss-settings-modal__footer">
...
@section('script')
    ...
    @vite('resources/js/df-field-category.js')
