...
@section('content')
    <div id="siteSettingsPage" class="ss-page ss-df-field-page">
        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Configure individual Datafuture fields, their categories, field type and reporting notes.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <aside class="ss-sidebar">
                    @php
                        $settingsSidebarIcon = 'database';
                        $settingsSidebarSubtitle = 'Datafuture setup';
                    @endphp
                    @include('pages.settings.sidebar')
                </aside>

                <section class="ss-content">
                    <div class="ss-table-card ss-df-field-card">
                        <div class="ss-table-card__header">
                            <div>
                                <h2>DF Fields List</h2>
                                <p>Mapped Datafuture fields grouped by category</p>
                            </div>
                            ...
                            <form id="tabulatorFilterForm" class="ss-table-filter">
                                <div class="ss-filter-field">
                                    ...
                                    <label class="ss-filter-input" for="query">
                                        ...
                                        <input id="query" name="query" type="text" placeholder="Search fields...">
                                    </label>
                                </div>
                                <div class="ss-filter-field">
                                    <span>Category</span>
                                    <label class="ss-filter-select ss-df-field-category-filter" for="category">
                        ...
                        <div class="ss-tabulator-wrap">
                            <div id="dfFieldTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div id="addSettingsModal" class="modal ss-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog ss-settings-modal__dialog ss-df-field-modal-dialog">
                <form method="POST" action="#" id="addSettingsForm" enctype="multipart/form-data" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-df-field-modal">
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-grid">
                                <div class="ss-modal-field">
                                    <label for="datafuture_field_category_id">Category <span>*</span></label>
                                    <label class="ss-modal-select" for="datafuture_field_category_id">
                                        <select id="datafuture_field_category_id" name="datafuture_field_category_id" class="datafuture_field_category_id">
                                    ...
                                    <div class="acc__input-error error-datafuture_field_category_id"></div>
                                </div>
                                <div class="ss-modal-field">
                                ...
                                <div class="ss-modal-field ss-modal-field--full">
                                    ...
                                    <input id="name" type="text" name="name" class="ss-modal-input inputUppercase name" placeholder="Field title">
                                    <div class="acc__input-error error-name"></div>
                                </div>
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="description">Description</label>
                                    <textarea id="description" name="description" class="ss-modal-input ss-modal-textarea description" rows="4" placeholder="Optional field description"></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <form method="POST" action="#" id="editSettingsForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-df-field-modal">
                        ...
                        <div class="modal-body ss-settings-modal__body">
                            <div class="ss-modal-grid">
                                <div class="ss-modal-field">
                                    <label for="edit_datafuture_field_category_id">Category <span>*</span></label>
                                    <label class="ss-modal-select" for="edit_datafuture_field_category_id">
                                        <select id="edit_datafuture_field_category_id" name="datafuture_field_category_id" class="datafuture_field_category_id">
                                            <option value="">Please Select</option>
                                            @if(!empty($categories))
                                                @foreach($categories as $cat)
                                                    <option value="{{ $cat->id }}">{{ $cat->name }}</option>
                                ...
                                <div class="ss-modal-field">
                                    ...
                                    <label class="ss-modal-select" for="edit_type">
                                        <select id="edit_type" name="type" class="type">
                                            <option value="">Please Select</option>
                                            <option value="date">Date</option>
                                            <option value="text">Text</option>
                                            <option value="number">Number</option>
                                ...
                                <div class="ss-modal-field ss-modal-field--full">
                                    ...
                                    <input id="edit_name" type="text" name="name" class="ss-modal-input inputUppercase name" placeholder="Field title">
                                    <div class="acc__input-error error-name"></div>
                                </div>
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="edit_description">Description</label>
                                    <textarea id="edit_description" name="description" class="ss-modal-input ss-modal-textarea description" rows="4" placeholder="Optional field description"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer ss-settings-modal__footer">
