        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Document Settings List</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto">Add New Document Settings</button>
                </div>
                <div class="p-5">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-3 form-check form-switch">
                                    <label class="form-check-label mr-3 ml-0" for="application">Application</label>
