        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Academic Years List</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto">Add New Academic Year</button>
                </div>
                <div class="p-5">
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="academicyearsTableId" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="#" id="addForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Add Academic Year</h2>
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="mt-3">
                                ...
                                <input id="from_date" name="from_date" type="text" class="form-control datepicker" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">    
                            ...
                            <div class="mt-3">
                                ...
                                <input id="to_date" name="to_date" type="text" class="form-control datepicker" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">    
                                <div class="acc__input-error error-to_date text-danger mt-2"></div>
                            </div>
                            <div class="mt-3">
                                <label for="target_date_hesa_report" class="form-label">Hesa Report Target Date</label>
                                <input id="target_date_hesa_report" name="target_date_hesa_report" type="text" class="form-control datepicker" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">    
                            </div>
                        </div>
                    </div>
    ...
    <div id="editModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="editForm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Edit Academic Year</h2>
                        <a data-tw-dismiss="modal" href="javascript:;">
                            <i data-lucide="x" class="w-5 h-5 text-slate-400"></i>
                        </a>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <label for="target_date_hesa_report" class="form-label">Hesa Report Target Date</label>
                            <input id="target_date_hesa_report" name="target_date_hesa_report" type="text" data-format="DD-MM-YYYY" class="form-control datepicker" placeholder="DD-MM-YYYY" data-single-mode="true">    
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-tw-dismiss="modal"
