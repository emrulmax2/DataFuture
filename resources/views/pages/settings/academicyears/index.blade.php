        ...
        <main class="ss-main">
            <section class="ss-title-card">
                <div class="ss-title-card__content">
                    ...
                    <div>
                        <h1>{{ $subtitle }}</h1>
                        <p>Manage academic years, term types, assessments, awarding bodies and qualifications.</p>
                    </div>
                </div>
            ...
            <div class="ss-workspace">
                ...
                <section class="ss-content">
                    @if(isset(auth()->user()->priv()['course_parameters']) && auth()->user()->priv()['course_parameters'] == 1)
                        <div class="ss-table-card ss-academicyears-card">
                            ...
                            <div class="ss-tabulator-wrap">
                                <div id="academicyearsTableId" class="ss-tabulator table-report table-report--tabulator"></div>
                            </div>
                        </div>
                    @else
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-grid">
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="add_name">Academic Year <span>*</span></label>
                                    <input id="add_name" type="text" name="name" class="ss-modal-input name" placeholder="2025/2026">
                                ...
                                <div class="ss-modal-field">
                                    <label for="add_from_date">From Date <span>*</span></label>
                                    <input id="add_from_date" name="from_date" type="text" class="ss-modal-input datepicker from_date" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">
                                    <div class="acc__input-error error-from_date"></div>
                                </div>

                                <div class="ss-modal-field">
                                    <label for="add_to_date">To Date <span>*</span></label>
                                    <input id="add_to_date" name="to_date" type="text" class="ss-modal-input datepicker to_date" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">
                                    <div class="acc__input-error error-to_date"></div>
                                </div>

                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="add_target_date_hesa_report">Hesa Report Target Date</label>
                                    <input id="add_target_date_hesa_report" name="target_date_hesa_report" type="text" class="ss-modal-input datepicker target_date_hesa_report" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">
                                    <div class="acc__input-error error-target_date_hesa_report"></div>
                                </div>
                            </div>
                        </div>
                ...
                <form method="POST" action="#" id="editForm" autocomplete="off">
                    <div class="modal-content ss-settings-modal ss-compact-settings-modal">
                        ...
                        <div class="ss-settings-modal__body">
                            <div class="ss-modal-grid">
                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="edit_name">Academic Year <span>*</span></label>
                                    <input id="edit_name" type="text" name="name" class="ss-modal-input name" placeholder="2025/2026">
                                    <div class="acc__input-error error-name"></div>
                                </div>
                                ...
                                <div class="ss-modal-field">
                                    <label for="edit_from_date">From Date <span>*</span></label>
                                    <input id="edit_from_date" name="from_date" type="text" class="ss-modal-input datepicker from_date" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">
                                    <div class="acc__input-error error-from_date"></div>
                                </div>

                                <div class="ss-modal-field">
                                    <label for="edit_to_date">To Date <span>*</span></label>
                                    <input id="edit_to_date" name="to_date" type="text" class="ss-modal-input datepicker to_date" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">
                                    <div class="acc__input-error error-to_date"></div>
                                </div>

                                <div class="ss-modal-field ss-modal-field--full">
                                    <label for="edit_target_date_hesa_report">Hesa Report Target Date</label>
                                    <input id="edit_target_date_hesa_report" name="target_date_hesa_report" type="text" class="ss-modal-input datepicker target_date_hesa_report" data-format="DD-MM-YYYY" placeholder="DD-MM-YYYY" data-single-mode="true">
                                    <div class="acc__input-error error-target_date_hesa_report"></div>
                                </div>
                            </div>
                        </div>
