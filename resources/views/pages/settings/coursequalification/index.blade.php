...
@section('subhead')
    <title>Course Qualifications</title>
@endsection
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Course Qualifications List</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto">Add New Course Qualification</button>
                </div>
                <div class="p-5">
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="qualificationTableId" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="#" id="addForm" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Add Course Qualification</h2>
                    ...
                    <div class="modal-body">
                        <div>
                            <label for="name" class="form-label"><span class="text-danger">*</span>Course Qualification</label>
    ...
    <div id="editModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="editForm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">Edit Course Qualification</h2>
                        <a data-tw-dismiss="modal" href="javascript:;">
                            <i data-lucide="x" class="w-5 h-5 text-slate-400"></i>
                        </a>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mt-3 hesa_code_area" style="display: none;">
                            <label for="edit_hesa_code" class="form-label">Hesa Code</label>
                        ...
                        <div class="mt-3 df_code_area" style="display: none;">
                            <label for="edit_df_code" class="form-label">DF Code</label>
