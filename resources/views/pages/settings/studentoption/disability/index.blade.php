    ...
    <div class="relative">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            ...
            <div class="flex mt-5 sm:mt-0">
                ...
                <button data-tw-toggle="modal" data-tw-target="#disabilitiesImportModal" type="button" class="import_btn btn btn-sm btn-pending shadow-md ml-2"><i data-lucide="navigation-2" class="w-4 h-4 mr-1"></i> Import</button>
            </div>
        </div>
    ...
    <!-- END: Edit Modal -->
    <!-- BEGIN: Import Modal -->
<div id="disabilitiesImportModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Import Disabilities</h2>
                <a data-tw-dismiss="modal" href="javascript:;">
                    <i data-lucide="x" class="w-5 h-5 text-slate-400"></i>
                </a>
            </div>
            <div class="modal-body">
                <form method="post"  action="{{ route('disabilities.import') }}" class="dropzone" id="disabilitiesImportForm" enctype="multipart/form-data">
                    @csrf
                    <div class="fallback">
                        <input name="import_disabilities_file" type="file" />
                    </div>
            ...
            <div class="modal-footer">
                <a style="float: left;" href="{{ route('disabilities.export') }}" id="downloadSample" class="btn btn-success text-white w-auto">Download Sample</a>
                <button type="button" data-tw-dismiss="modal"
                    class="btn btn-outline-secondary w-20 mr-1">Cancel</button>
                <button id="saveDisabilities" class="btn btn-primary w-auto">Upload</button>
            </div>
        </div>
