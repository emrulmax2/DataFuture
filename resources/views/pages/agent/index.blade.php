...
@section('subcontent')
    <div class="agm-page agm-agent-user-page">
        <section class="agm-hero">
            <div class="agm-hero__copy">
                ...
                <div>
                    <span class="agm-eyebrow">Agent Creations</span>
                    <h1>Agent List</h1>
                    <p>All recruitment partners and their referral codes</p>
                </div>
            </div>

            <div class="agm-hero__actions">
                <a href="{{ route('agent.management') }}" class="agm-btn agm-btn--cream">
                    <span class="agm-btn__icon-chip">
                        <i data-lucide="users"></i>
                    </span>
        ...
        <section class="agm-agent-panel">
            <div class="agm-agent-toolbar">
            ...
            <div id="agentTableId" class="agm-agent-table"></div>
        </section>
    </div>

    <div id="addAgentModal" class="modal agm-agent-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="agm-agent-form-grid">
                            ...
                            <div class="agm-agent-form-field agm-agent-form-field--wide">
                                ...
                                <div class="agm-agent-input-icon">
                                    ...
                                    <input id="email" type="email" name="email" placeholder="agent@example.com">
                                </div>
                            ...
                            <div class="agm-agent-form-field agm-agent-form-field--wide">
                                <label class="agm-agent-toggle-card" for="is_default">
                                    <input id="is_default" class="agm-agent-option-input" name="is_default" value="1" type="checkbox">
                                    <span class="agm-agent-option-card">
                                        ...
                                        <span>
                                            ...
                                            <small class="agm-agent-option-hint--off">Not the default referral agent</small>
                                            <small class="agm-agent-option-hint--on">Yes - default referral agent</small>
                                        </span>
                                    </span>
                                </label>
                            </div>
    ...
    <div id="editAgentModal" class="modal agm-agent-modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <div class="agm-agent-form-grid">
                            ...
                            <div class="agm-agent-form-field agm-agent-form-field--wide">
                                ...
                                <div class="agm-agent-input-icon">
                                    <i data-lucide="mail"></i>
                                    <input id="email1" type="email" name="email" placeholder="agent@example.com">
                                </div>
                                <div class="acc__input-error error-email"></div>
                            </div>
                            <div class="agm-agent-form-field">
                            ...
                            <div class="agm-agent-form-field agm-agent-form-field--wide">
                                <label class="agm-agent-toggle-card" for="edit_is_default">
                                    <input id="edit_is_default" class="agm-agent-option-input" name="is_default" value="1" type="checkbox">
                                    <span class="agm-agent-option-card">
                                        <span class="agm-agent-option-mark">
                                            <i data-lucide="x" class="agm-agent-option-mark__off"></i>
                                            <i data-lucide="check" class="agm-agent-option-mark__on"></i>
