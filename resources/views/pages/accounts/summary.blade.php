...
<div class="intro-y news xl:w-3/5 p-5 box mt-8">
        ...
        <div class="intro-y mt-6">
            <div class="news__preview image-fit">
                <img alt="London Churchill College" class="rounded-md" src="{{ asset('build/assets/images/' . $fakers[0]['images'][0]) }}">
            </div>
        </div>
        <div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
            ...
            <div class="intro-x flex mr-3">
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit">
                    <img alt="London Churchill College" class="rounded-full border border-white zoom-in tooltip" src="{{ asset('build/assets/images/' . $fakers[0]['photos'][0]) }}" title="{{ $fakers[0]['users'][0]['name'] }}">
                </div>
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit -ml-4">
                    <img alt="London Churchill College" class="rounded-full border border-white zoom-in tooltip" src="{{ asset('build/assets/images/' . $fakers[0]['photos'][1]) }}" title="{{ $fakers[0]['users'][1]['name'] }}">
                </div>
                <div class="intro-x w-8 h-8 sm:w-10 sm:h-10 image-fit -ml-4">
                    <img alt="London Churchill College" class="rounded-full border border-white zoom-in tooltip" src="{{ asset('build/assets/images/' . $fakers[0]['photos'][2]) }}" title="{{ $fakers[0]['users'][2]['name'] }}">
                </div>
            </div>
        ...
        <div class="intro-y mt-5 pb-10">
            ...
            <div class="mt-5 pt-5 border-t border-slate-200/60 dark:border-darkmode-400">
                <div class="flex">
                    <div class="w-10 h-10 sm:w-12 sm:h-12 flex-none image-fit">
                        <img alt="London Churchill College" class="rounded-full" src="{{ asset('build/assets/images/' . $fakers[0]['photos'][1]) }}">
                    </div>
                    <div class="ml-3 flex-1">
                        <div class="flex items-center">
