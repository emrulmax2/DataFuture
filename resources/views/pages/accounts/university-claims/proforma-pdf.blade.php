                ...
                <table>
                    <tr>
                        ...
                        <td class="w-50 text-right v-middle">
                            <h2 class="uppercase font-bold">PROFORMA INVOICE</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="w-50 v-top">
                            ...
                            <h2 class="invoiceTotal">{{ Number::currency($claim->proforma_total, 'GBP') }}</h2>
                            <div class="invBar"></div>
                            <div class="invoiceText">
                                <div class="mb-3">Date: {{ !empty($claim->claim_date) ? date('d/m/Y', strtotime($claim->claim_date)) : 'N/A' }}</div>
                                <div class="mb-0">Proforma Invoice no: {{ !empty($claim->proforma_no) ? $claim->proforma_no : 'N/A' }}</div>
                            </div>
                        </td>
                        ...
                        <td class="w-30 v-top">
                            <table>
                                <tr class="subtotalRow">
                                    <td>Subtotal:</td>
                                    <td class="text-right">{{ Number::currency($claim->proforma_total, 'GBP') }}</td>
                                </tr>
                                <tr class="totalRow">
                                    <td>Total:</td>
                                    <td class="text-right">{{ Number::currency($claim->proforma_total, 'GBP') }}</td>
