...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Venues List</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button data-tw-toggle="modal" data-tw-target="#addVenueModal" type="button" class="add_btn btn btn-primary shadow-md mr-2">Add New Venue</button>
        </div>
    </div>
    ...
    <!-- END: HTML Table Data -->
    <!-- BEGIN: Add Modal -->
    <div id="addVenueModal" class="modal" tabindex="-1" aria-hidden="true">
    ...
    <!-- END: Add Modal -->
    <!-- BEGIN: Edit Modal -->
    <div id="editVenueModal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
