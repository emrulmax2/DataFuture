                ...
                <div class="w-full py-3 border-cyan-600 border-2 rounded-b-lg bg-transparent h-full">
                    <div class="w-full px-5 py-3  text-xl">
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-1 ml-auto py-3 font-medium ">{{ $TopAttendanceCriteria +  $expectedResult }}</div>
                        </div>
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-1 ml-auto py-3 font-medium ">{{ $attendance_criteria +  $achivedResult }}</div>
                        </div>
                    </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <div class="w-full px-5 py-3 border-cyan-600 border-2 rounded-b-md bg-transparent">
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-1 font-medium ml-2 py-3">{{ $expectedResult }}</div>
                                </div>
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-1 font-medium ml-2 py-3">{{ $achivedResult }}</div> 
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-span-12">
                            <table class="w-full">
                                <thead>
                                    ...
                                    <tr>
                                        <th colspan="3" class="text-right font-medium px-5 py-3 border-0 dark:border-darkmode-300 whitespace-nowrap">{{ $achivedResult }} / {{ $expectedResult }}</th>
                                    </tr>
                                </thead>
                                <tbody>
