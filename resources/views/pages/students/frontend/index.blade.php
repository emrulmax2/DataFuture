                    ...
                    <div id="currentAdressQuestion"  class="col-span-12">
                        <div class="col-span-12">
                                <div class="intro-y col-span-12 py-1">
                                    <label for="input-wizard-4" class="form-label inline-flex mr-2">When you submitted your application, you supplied us with the address <b> {{ $studentData["current_address"]->address_line_1 }},{{ $studentData["current_address"]->address_line_2 ? $studentData["current_address"]->address_line_2."," : '' }} {{ isset($studentData["current_address"]->post_code) ? $studentData["current_address"]->post_code."," : '' }} {{ isset($studentData["current_address"]->city) ? $studentData["current_address"]->city."," : '' }} {{ $studentData["current_address"]->country }}</b>. Is this the address where you will be residing during your study term?</label>
