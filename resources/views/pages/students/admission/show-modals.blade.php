                    ...
                    <div class="grid grid-cols-12 gap-4 gap-y-5">
                        ...
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <select id="gender" class="lccTom lcc-tom-select w-full" name="gender">
                                <option value="" selected>Please Select</option>
                                <option {{ isset($applicant->gender) && $applicant->gender == 'MALE' ? 'Selected' : '' }} value="MALE">MALE</option>
                                <option {{ isset($applicant->gender) && $applicant->gender == 'FEMALE' ? 'Selected' : '' }} value="FEMALE">FEMALE</option>
                                <option {{ isset($applicant->gender) && $applicant->gender == 'OTHERS' ? 'Selected' : '' }} value="OTHERS">OTHERS</option>
                            </select>
                                    ...
                                    <select id="course_creation_id" class="lcc-tom-select w-full" name="course_creation_id">
                                        ...
                                        @if(!empty($instance))
                                            @foreach($instance as $ci)
                                                <option {{ isset($applicant->course->course_creation_id) && $applicant->course->course_creation_id == $ci->creation->id ? 'selected' : ''}} value="{{ $ci->creation->id }}">{{ $ci->creation->course->name }} - {{ $ci->creation->semester->name }}</option>
                                            @endforeach 
                                        @endif 
                                    </select>
