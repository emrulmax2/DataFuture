                ...
                <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                    <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                        <div class="w-20 h-20 sm:w-24 sm:h-24 flex-none lg:w-32 lg:h-32 image-fit relative">
                            <img alt="{{ $applicant->title->name.' '.$applicant->first_name.' '.$applicant->last_name }}" class="rounded-full" src="{{ (isset($applicant->photo) && !empty($applicant->photo) && Storage::disk('google')->exists('public/applicants/'.$applicant->id.'/'.$applicant->photo) ? Storage::disk('google')->url('public/applicants/'.$applicant->id.'/'.$applicant->photo) : asset('build/assets/images/placeholders/200x200.jpg')) }}">
