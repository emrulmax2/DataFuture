    ...
    <div class="row div_print_table" style="">
      <div class="header">
        <table class="print_table">
            ...
            <tr>
                <td colspan="4" style="text-align:right;">Date: {{ (!empty($payment->payment_date) ? date('jS M, Y', strtotime($payment->payment_date)) : date('jS M, Y')) }}</td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right;">Invoice# {{ $payment->invoice_no }}</td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right;">Student Name: {{ $student->full_name }}</td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right;">Student Mobile: {{ $student->contact->mobile }}</td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right;">{!! $address !!}</td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right;">Student ID: {{ $student->registration_no }}</td>
            </tr>
        </table>
      </div>
