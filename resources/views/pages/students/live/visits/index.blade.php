        ...
        <div class="intro-y box p-4 sm:p-5">
            <div class="grid grid-cols-12 gap-0 items-center">
                ...
                <div class="col-span-6 text-right">
                    ...
                    <a href="javascript:void(0)" class="btn btn-primary w-auto mr-0 mb-0" data-tw-toggle="modal" data-tw-target="#addVisitModal">
                        <i data-lucide="plus" class="w-4 h-4 mr-2"></i> Add New Visit
                    </a>
                    @endif
                </div>
            </div>
