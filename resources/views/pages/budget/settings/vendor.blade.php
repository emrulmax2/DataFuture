...
@section('subcontent')
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Vendors</h2>
                    <button data-tw-toggle="modal" data-tw-target="#addBudgetVendorModal" type="button" class="add_btn btn btn-primary shadow-md ml-auto"><i data-lucide="plus-circle" class="w-4 h-4 mr-2"></i> Add Vendor</button>
                </div>
                <div class="p-5">
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div id="budgetVendorListTable" class="mt-5 table-report table-report--tabulator"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- BEGIN: Edit Modal -->
    <div id="editBudgetVendorModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="editBudgetVendorForm" enctype="multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="edit_email" type="text" name="email" class="form-control w-full">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="updateVenBtn" class="btn btn-primary w-auto">     
                            Update                      
...
@section('script')
    ...
    @vite('resources/js/budget-settings-vendors.js')
@endsection