                                ...
                                <div class="flex items-center justify-start mt-4">
                                    <div class="dropdown">
                                        <button class="dropdown-toggle btn btn-primary" aria-expanded="false" data-tw-toggle="dropdown">
                                            2023 May HND<i data-lucide="chevron-down" class="w-4 h-4 ml-2"></i>
                                        </button>
                                        <div class="dropdown-menu w-48">
                                            <ul class="dropdown-content">
                                                <li>
                                                    <a href="#" class="dropdown-item">
                                                        <i data-lucide="check-circle" class="w-4 h-4 mr-2"></i> 2023 September HND
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" class="dropdown-item">
                                                        <i data-lucide="check-circle" class="w-4 h-4 mr-2"></i> 2024 January HND
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                    <div class="ml-0 mr-auto">
                                        <div class="font-medium">Businese Environment</div>
                                        <div class="text-slate-500 text-xs mt-0.5">Group B</div>
                                    </div>
                                    <div class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">38</div>
                                </div>
                            </div>
                            <div class="intro-y">
                                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
