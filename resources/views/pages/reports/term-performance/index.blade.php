...
@section('subcontent')
    ...
    <div class="intro-y box p-5 mt-5">
        <div id="termPerformanceReportAccordion" class="accordion accordion-boxed pt-2">
            ...
            <div class="accordion-item">
                <div id="termPerformanceReportAccordion-3" class="accordion-header">
                    <button id="studentSearchBtn" class="accordion-button collapsed relative w-full text-lg font-semibold" type="button" data-tw-toggle="collapse" data-tw-target="#termPerformanceReportAccordion-collapse-3" aria-expanded="false" aria-controls="termPerformanceReportAccordion-collapse-3">
                        Application Analysis
                        <span class="accordionCollaps"></span>
                    </button>
                </div>
                <div id="termPerformanceReportAccordion-collapse-3" class="accordion-collapse collapse" aria-labelledby="termPerformanceReportAccordion-3" data-tw-parent="#termPerformanceReportAccordion">
                    <div class="accordion-body">
