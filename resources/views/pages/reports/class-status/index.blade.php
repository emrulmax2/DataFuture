        ...
        <form action="#" method="post" id="classStatusForm">
            ...
            <div class="grid grid-cols-12 gap-0 gap-y-2 gap-x-4">
                ...
                <div class="col-span-12 sm:col-span-9 ml-auto mt-auto text-right">
                    <button type="submit" id="classStatusForm" class="btn btn-success text-white ml-auto w-auto"><i class="w-4 h-4 mr-2" data-lucide="search"></i> Search</button>
                </div>
            </div>
        </form>

        <div class="overflow-x-auto scrollbar-hidden pt-5 statusReportListTableWrap" style="display: none;">
