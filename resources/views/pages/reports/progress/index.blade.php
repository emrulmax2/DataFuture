...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Progress Monitoring Report</h2>
    ...
    <div class="intro-y box p-5 mt-5">
        <form action="#" method="post" id="studentGroupSearchForm">
            ...
            <div class="grid grid-cols-12 gap-0 gap-y-2 gap-x-4">
                ...
                <div class="col-span-12 sm:col-span-3" style="display: none;">
                ...
                <div class="col-span-12 sm:col-span-3">
                    ...
                    <div class="form-check mt-2">
                        <input id="hard_copy_check-1" class="form-check-input" type="radio" value="Yes" name="group[certificate_claimed]" value="vertical-radio-chris-evans">
                        <label class="form-check-label" for="hard_copy_check-1">Yes</label>
                    </div>
                    <div class="form-check mt-2">
                        <input id="hard_copy_check-2" class="form-check-input" type="radio" value="No" name="group[certificate_claimed]" value="vertical-radio-liam-neeson">
                        <label class="form-check-label" for="hard_copy_check-2">No</label>
                    </div>
                </div>
                
                <div class="col-span-12 sm:col-span-3 ml-auto mt-auto flex">
                    <button onclick="location.reload()" type="button" class="btn btn-danger text-white ml-auto w-auto inline-flex mr-2"><i class="w-4 h-4 mr-2" data-lucide="refresh-cw"></i> Reset</button>
                    <button id="studentGroupSearchSubmitBtn" type="submit" class="btn btn-success text-white ml-auto  w-36 xl:w-64"><i class="w-4 h-4 mr-2" data-lucide="search"></i> Search <i data-loading-icon="oval" data-color="white" class="w-4 h-4 ml-2 hidden loadingCall"></i></button>
                </div>
...
@section('script')
    @vite('resources/js/student-result-progress-form.js')
@endsection