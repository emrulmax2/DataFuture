        ...
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form id="tabulatorFilterForm-mc" class="xl:flex sm:mr-auto" >
                ...
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    ...
                    <select id="instance_term-mc" name="instance_term" class="form-select w-full mt-2 sm:mt-0 sm:w-auto" >
                        <option value="">Please Select</option>
                        @if(!empty($terms))
                ...
                <div class="mt-2 xl:mt-0">
                    <button id="tabulator-html-filter-go-mc" type="button" class="btn btn-primary w-full sm:w-16" >Go</button>
                    <button id="tabulator-html-filter-reset-mc" type="button" class="btn btn-secondary w-full sm:w-16 mt-2 sm:mt-0 sm:ml-1" >Reset</button>
                </div>
            </form>
