...
@endphp
<table cellpadding="0" cellspacing="0" border="0" width="830" bgcolor="#FFFFFF" style="border-collapse:collapse; width:830px; background-color:#FFFFFF;; box-shadow:0 16px 44px rgba(18,41,74,.34), 0 3px 10px rgba(18,41,74,.14);">
  <tr>
