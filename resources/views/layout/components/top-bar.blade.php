...
<!-- BEGIN: Top Bar -->
<div class="top-bar-boxed hr-topbar {{ isset($class) ? $class : '' }} h-[70px] md:h-[65px] z-[51] mt-12 md:mt-0 -mx-3 sm:-mx-8 md:-mx-0 px-3 relative md:fixed md:inset-x-0 md:top-0 sm:px-8 md:px-10">
