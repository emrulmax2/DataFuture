...
class AttendanceReportController extends Controller
{
    ...
    public function excelDownload(Request $request){
        ...
        $theCollection = [];
        $theCollection[1][0] = 'Reg No';
        $theCollection[1][1] = 'Name';
        $theCollection[1][2] = 'Date of Birth';
        $theCollection[1][3] = 'Semester';
        $theCollection[1][4] = 'Course';
        $theCollection[1][5] = 'SSN';
        $theCollection[1][6] = 'Awarding Body Ref';
        $theCollection[1][7] = 'Status';
        $theCollection[1][8] = 'Mobile';
        $theCollection[1][9] = 'Email';
        $theCollection[1][10] = 'Group';
        $theCollection[1][11] = 'P';
        $theCollection[1][12] = 'O';
        $theCollection[1][13] = 'A';
        $theCollection[1][14] = 'E';
        $theCollection[1][15] = 'M';
        $theCollection[1][16] = 'H';
        $theCollection[1][17] = 'L';
        $theCollection[1][18] = 'LE';
        $theCollection[1][19] = 'TC';
        $theCollection[1][20] = 'Percentage(%)';
        $theCollection[1][21] = 'Percentage W/O Excused(%)';

        $row = 2;
        if(!empty($Query)):
            foreach($Query as $list):
                $theCollection[$row][0] = $list->registration_no;
                $theCollection[$row][1] = $list->first_name.' '.$list->last_name;
                $theCollection[$row][2] = (isset($list->date_of_birth) && !empty($list->date_of_birth) ? date('d-m-Y', strtotime($list->date_of_birth)) : '');
                $theCollection[$row][3] = (isset($list->semester_name) && !empty($list->semester_name) ? $list->semester_name : '');
                $theCollection[$row][4] = (isset($list->course_name) && !empty($list->course_name) ? $list->course_name : '');
                $theCollection[$row][5] = $list->ssn_no;
                $theCollection[$row][6] = (isset($list->reference) && !empty($list->reference) ? $list->reference : '');
                $theCollection[$row][7] = $list->status;
                $theCollection[$row][8] = $list->mobile;
                $theCollection[$row][9] = $list->institutional_email;
                $theCollection[$row][10] = $list->group_name;
                $theCollection[$row][11] = $list->P;
                $theCollection[$row][12] = $list->O;
                $theCollection[$row][13] = $list->A;
                $theCollection[$row][14] = $list->E;
                $theCollection[$row][15] = $list->M;
                $theCollection[$row][16] = $list->H;
