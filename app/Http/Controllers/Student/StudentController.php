...
class  StudentController extends Controller
{
    ...
    public function show($studentId){
        ...
        return view('pages.students.live.show', [
            ...
            'PreviousProviders' => PreviousProvider::where('active', 1)->get(),
            'QualificationTypeIdentifiers' => QualificationTypeIdentifier::where('active', 1)->get(),
            'HighestQualificationOnEntrys' => HighestQualificationOnEntry::where('active', 1)->get(),
            'HesaQualificationSubjects' => HesaQualificationSubject::where('active', 1)->get(),
            'HesaExamSittingVenues' => HesaExamSittingVenue::where('active', 1)->get(),
    ...
    protected function PlanWithAttendanceSet(Student $student) {
            ...
            $cacheKey = 'plan_with_attendance_set_student_' . ($student->id ?? '0').'_course_' . ($student->crel->id ?? '0');
