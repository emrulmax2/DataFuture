            ...
            foreach($res as $course_id => $tutorContent):
                ...
                foreach($tutorContent as $tutor_id => $modules):
                    ...
                    if(!empty($modules)):
                        ...
                        $MAILBODY .= '<table class="border: 1px solid #ddd; width: 100%; border-spacing: 0; border-collapse: collapse;">';
                            $MAILBODY .= '<thead>';
                                $MAILBODY .= '<tr>';
                                    $MAILBODY .= '<th>#</th>';
                                    $MAILBODY .= '<th>Course</th>';
                                    $MAILBODY .= '<th>Module</th>';
                                    $MAILBODY .= '<th>Group</th>';
                                    $MAILBODY .= '<th>Document</th>';
                                $MAILBODY .= '</tr>';
                            $MAILBODY .= '</thead>';
                            $MAILBODY .= '<tbody>';
                                $sl = 1;
                                foreach($modules as $module):
                                    $MAILBODY .= '<tr>';
                                        $MAILBODY .= '<td>'.$course->name.'</td>';
                                        $MAILBODY .= '<td>'.$module['module'].'</td>';
                                        $MAILBODY .= '<td>'.$module['group'].'</td>';
                                        $MAILBODY .= '<td>'.$module['tsks'].'</td>';
                                    $MAILBODY .= '</tr>';
                                    $sl += 1;
                                endforeach;
                            $MAILBODY .= '</tbody>';
