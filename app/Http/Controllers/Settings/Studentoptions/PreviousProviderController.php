...
use App\Exports\PreviousProviderExport;
use App\Imports\PreviousProviderImport;
...
class PreviousProviderController extends Controller
{
    ...
    {
        return Excel::download(new PreviousProviderExport(), 'previousprovider.csv');        
    }

    public function import(Request $request) {
        $file = $request->file('file');
        
        Excel::import(new PreviousProviderImport(),$file);
