...
class VisaExpiredCron extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'visaexpired:cron';
     ...
     * @var string
     */
    protected $description = 'Visa exired cron job';
    ...
    public function handle()
    {
        ...
        if($visaExpry->count() > 0):
            ...
            $PDF_title = 'Urgent Visa Update Required';
                        ...
                        $PDFHTML .= '<div class="bodyContainer">';
                            ...
                            $PDFHTML .= '<div class="letterConent">';
                                    ...
                                    $PDFHTML .= '<p class="mb-15 text-justify">';
                                        $PDFHTML .= '<strong>Our record shows that your visa was expired on '.date('d/m/Y', strtotime($workpermit_expire)).'.</strong>';
                                    $PDFHTML .= '</p>';
                                    $PDFHTML .= '<p class="mb-15 text-justify">';
