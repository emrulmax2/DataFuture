        ...
        foreach($applicantContactData as $applicantContact):
            ...
            if(isset($this->applicant->previous_student_id) && $this->applicant->previous_student_id!=""):
                $prevStudentData = [
                    ...
                    'institutional_email' => isset($prevStudent->contact->institutional_email) ? $prevStudent->contact->institutional_email : null,
                    'institutional_email_verification' => isset($prevStudent->contact->institutional_email_verification) ? $prevStudent->contact->institutional_email_verification : null,
                ];
